...
*/
/* jshint-desc: browser: true, css: true, curly: true, debug: true, devel: true, eqeqeq: true, esversion: 5, evil: false, noarg: true, undef: true, unused: true, white: true, windows: true */

/*jslint debug: true, es5: true, white: true, nomen: true, plusplus: true, undef: false, sloppy: false, sub: false, passfail: false, browser: true, devel: true, node: false, rhino: false, windows: true, indent: 2, maxerr: 100 */
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  */
    ...
    EC.errorValue = document.querySelector("#errorValue");
    EC.errorMsg = document.querySelector("#errorMsg");
    EC.warnMsg = document.querySelector("#warnMsg");
    EC.clearErrorF();
    ...
    */
    let lastBgColor = "rgba(0,0,255,0.9)";
    ...
    // BUG: Default nothing set ??? Else RGB only.
    if(actBgColor === ('rgba(0,0,0,0)')) { // Default transparent
      //console.info("colorInit transparent: lastBgColor=%s actBgColor=%s", lastBgColor, actBgColor);
      if(EC.testLocalStorage() === true) {
        //console.log("colorInit: localStorage aviable");
